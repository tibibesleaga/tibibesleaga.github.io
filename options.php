...
<div class="wrap">
  ...
  <form method="post" action="options.php">
    ...
    <?php
      ...
      tb_options_field( __( 'Sidebar position' ), '', 'radio_group', 'fastblog[sidebar]', fastblog_get_option( 'sidebar' ), array
      (
    ...
    <?php
      ...
      tb_options_field( __( 'Logo text or image path', 'fastblog' ), '', 'input_code', 'fastblog[header][logo]', fastblog_get_option( 'header/logo' ), '('.__( 'empty = default', 'fastblog' ).')' );
