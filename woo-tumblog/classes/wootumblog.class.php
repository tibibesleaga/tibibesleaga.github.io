...
class WooTumblog {
	...
	function WooTumblog() {
		...
		update_option('woo_tumblog_version', '2.1.1');
	    ...
	    if ( function_exists('add_meta_box') ) {
	    	...
	    	if ( function_exists('get_post_types') ) {
				...
				foreach ($custom_post_list as $type){
					add_meta_box('woothemes-tumblog-settings', 'Tumblog Custom Settings',array(&$this, 'woothemes_tumblog_metabox_create'),$type,'normal','high'); // Priority is high making it the first block under the editor
				}
	    	} else {
	    		add_meta_box('woothemes-tumblog-settings', 'Tumblog Custom Settings',array(&$this, 'woothemes_tumblog_metabox_create'),'post','normal','high'); // Priority is high making it the first block under the editor
	        	add_meta_box('woothemes-tumblog-settings', 'Tumblog Custom Settings',array(&$this, 'woothemes_tumblog_metabox_create'),'page','normal','high'); // Priority is high making it the first block under the editor
	    	}
